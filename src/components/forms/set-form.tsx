...
export function SetForm({ cotizacionId, cliente, contacto, numCotizacion, areas = [] }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Nombre del paciente */}
      <div className="bg-white rounded-xl border shadow-sm p-5">
        <h2 className="font-semibold text-slate-700 mb-4 text-sm">Datos del paciente <span className="font-normal text-slate-400">(opcional — solo para muestras biológicas)</span></h2>
