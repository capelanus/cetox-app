...
// Deduce el área a partir del rol y area del usuario
...
export default function NuevaSolicitudPage() {
  ...
  const area = (session?.user as { area?: string })?.area ?? null
  const areaDeducida = deducirArea(rol, area)
  ...
  return (
    <div className="p-6 max-w-3xl space-y-6">
      ...
      <form action={handleSubmit} className="space-y-5">
        {/* Área solicitante (read-only, deducida del perfil) */}
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
          <strong>ℹ️ Nota:</strong> Tu solicitud se enviará automáticamente al área de Operaciones en estado <em>Enviado</em>.
          Recibirás actualizaciones de estado conforme avance el proceso de compra.
        </div>
