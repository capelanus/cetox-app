...
export default function ProveedoresFilters({ especialidades, currentQ, currentEspecialidad, currentEstado }: Props) {
  ...
  const hasFilters = !!(currentQ || currentEspecialidad || currentEstado)
    ...
    <div className="flex flex-wrap gap-3 items-center">
      ...
      <div className="relative flex-1 min-w-[240px]">
        ...
        <input
          ...
          onKeyDown={e => {
            if (e.key === 'Enter') {
              navigate({ q: (e.target as HTMLInputElement).value || undefined, especialidad: currentEspecialidad, estado: currentEstado })
            }
          }}
        />
      </div>
      ...
      <select
        ...
        onChange={e => navigate({ q: currentQ, especialidad: e.target.value || undefined, estado: currentEstado })}
      ...
      <select
        value={currentEstado ?? ''}
        onChange={e => navigate({ q: currentQ, especialidad: currentEspecialidad, estado: e.target.value || undefined })}
