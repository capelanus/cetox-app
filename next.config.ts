...
// Note: X-Frame-Options and frame-ancestors are handled in middleware (src/middleware.ts)
// so they can vary per route without the headers() config stacking duplicates.
const cspDirectives = [
  "default-src 'self'",
